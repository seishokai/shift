...
var COLORS = {
  ...
  '希望休':'#999999','出勤希望':'#2e7d32',
  'ｴｽｶ(休出)':'#c0392b','ｱｰﾙ(休出)':'#7030a0','ｳｨｽﾞ(休出)':'#1e8449','ﾙﾐﾅｽ(休出)':'#27ae60',
  '茶屋(休出)':'#d4a017','知立(休出)':'#0a6b8a','小牧(休出)':'#d81b60','八事(休出)':'#8b4513',
  '大森(休出)':'#1f6b4e','京都(休出)':'#6b3a87','銀座(休出)':'#7d6608','ｱｻﾉ(休出)':'#85200c','東員(休出)':'#b85c00'
};
...
var CLOSED_WEEKDAY = {'小牧':2,'知立':3,'京都':4,'大森':4,'茶屋':4,'東員':0,'銀座':1};
